...
/* SIGNATURE MOMENT: time-of-day-greeting */
(function(){

      (function(){
        var hour = new Date().getHours(); var greeting = hour < 5 ? 'Working late' : hour < 12 ? 'Good morning' : hour < 18 ? 'Good afternoon' : 'Good evening';
        var el = document.createElement('div'); el.className = 'zsm-greeting'; el.textContent = greeting; document.body.appendChild(el);
        setTimeout(function(){ el.classList.add('is-visible'); }, 800);
        setTimeout(function(){ el.classList.remove('is-visible'); }, 4500);
      })();
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '3be98112-af21-467a-9a1b-a0bb9be1061b',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '3be98112-af21-467a-9a1b-a0bb9be1061b';
...
(function(){
  try {
    ...
    function isDecorativeAccentText(el){
      ...
      if(el.matches('.display-xl,.display-1,.display-2,[class*="hero-word"],[class*="hero-pizza"],[class*="hero-anywhere"],[class*="pizza-word"],[class*="anywhere-word"],[class*="logotype"],[class*="wordmark"]'))return true;
      if(el.closest('[class*="hero-word"],[class*="hero-pizza"],[class*="hero-anywhere"],[class*="pizza-word"],[class*="anywhere-word"],[class*="logotype"],[class*="wordmark"]'))return true;
      return false;
    }
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '3be98112-af21-467a-9a1b-a0bb9be1061b';
